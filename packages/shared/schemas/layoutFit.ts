...
export const AdaptiveLayoutCandidateReportSchema = z.object({
  ...
  measurement: z.object({
    ...
    underfilledBlocks: z.number().int().nonnegative().optional(),
    fillRatios: z.array(z.object({ blockId: z.string(), fillRatio: z.number().min(0).max(1) })).optional(),
    ...
    placeholderImages: z.number().int().nonnegative().optional(),
    realRenderedImages: z.number().int().nonnegative().optional(),
    ...
    pageMetrics: z.array(z.object({
      page: z.number().int().positive(),
      blockCount: z.number().int().nonnegative(),
      contentBlockCount: z.number().int().nonnegative(),
      imageBlocks: z.number().int().nonnegative(),
      clippedBlocks: z.number().int().nonnegative(),
      overflowBlocks: z.number().int().nonnegative(),
      missingImages: z.number().int().nonnegative(),
      placeholderImages: z.number().int().nonnegative().optional(),
...
export const LayoutFitReportSchema = z.object({
  ...
  coverRenderFit: z.number().optional(),
  coverClippedBlocks: z.number().int().nonnegative().optional(),
  coverOverflowBlocks: z.number().int().nonnegative().optional(),
  coverMissingImages: z.number().int().nonnegative().optional(),
