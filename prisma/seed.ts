...
const TRILOGY_TEMPLATES: TrilogyTemplateSeed[] = [
  {
    ...
    slots: [
      ...
      trilogySlot("t-trilogy-cu-p3-body-b", 3, "body", 7, 1, 6, 5, { minWords: 180, maxWords: 300 }),
      trilogySlot("t-trilogy-cu-p3-image", 3, "image", 1, 6, 12, 3, { aspect: "landscape" }),
      trilogySlot("t-trilogy-cu-p3-sidebar", 3, "sidebar", 1, 9, 12, 2, { maxWords: 120 }),
      trilogySlot("t-trilogy-cu-p4-calendar", 4, "calendar", 1, 1, 12, 4, { minWords: 120, maxWords: 220 }, "calendar"),
      trilogySlot("t-trilogy-cu-p4-body-a", 4, "body", 1, 5, 6, 3, { minWords: 120, maxWords: 220 }),
      trilogySlot("t-trilogy-cu-p4-body-b", 4, "body", 7, 5, 6, 3, { minWords: 120, maxWords: 220 }),
      trilogySlot("t-trilogy-cu-p4-image", 4, "image", 1, 8, 6, 3, { aspect: "landscape" }),
      trilogySlot("t-trilogy-cu-p4-sidebar", 4, "sidebar", 7, 8, 6, 3, { maxWords: 120 }),
    ],
  },
  {
